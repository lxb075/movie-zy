...
const moviesData=[
    ...
    {id:6,title:'你的名字',cover:'https://picsum.photos/seed/yourname/500/600.jpg',type:['动漫'],genre:['爱情','奇幻'],score:8.8,desc:'在日本的某个乡下小镇的高中女生三叶，每天过着忧郁的生活，而她的梦想则是能够成为东京的帅哥。',date:'2016-08-26',like:16780,collect:11230,hot:9000,rating:4.7,playUrl:'https://www.baidu.com/s?wd=你的名字%20在线观看'},
    ...
    {id:11,title:'灌篮高手',cover:'https://picsum.photos/seed/slamdunk/500/600.jpg',type:['动漫'],genre:['喜剧','运动'],score:9.2,desc:'为了讨好暗恋对象赤木晴子，樱木花道加入篮球队。他从篮球小白成长为球队核心，带领球队向全国大赛发起冲击。',date:'1993-10-16',like:23140,collect:16780,hot:9850,rating:4.8,playUrl:'https://www.baidu.com/s?wd=灌篮高手%20在线观看'},
