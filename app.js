// ==================== 数据定义 ====================
const moviesData = [
    { id: 1, title: "星际穿越", cover: "https://m.media-amazon.com/images/M/MV5BYzdjMDAxZGItMjI2My00ODA1LTlkNzItOWFjMDU5ZDJlYWY3XkEyXkFqcGc@._V1_.jpg", type: ["电影"], genre: ["科幻", "冒险"], score: 9.4, desc: "在地球面临生存危机之际，一群勇敢的探险家利用新发现的虫洞，超越人类太空旅行的极限，在广袤的宇宙中展开星际航行。", date: "2014-11-07", like: 12890, collect: 8560, hot: 9500, rating: 4.8, playUrl: "https://www.baidu.com/s?wd=星际穿越%20在线观看" },
    { id: 2, title: "鬼灭之刃", cover: "https://m.media-amazon.com/images/M/MV5BZjZjNzI5MDctY2Y4YS00NmM4LTljMmItZTFkOTExNGI3ODRhXkEyXkFqcGc@._V1_.jpg", type: ["动漫"], genre: ["动作", "奇幻"], score: 9.1, desc: "为了拯救被鬼杀死的家人，以及让变成鬼的妹妹豆子变回人类，炭治郎成为了鬼杀队的一员，展开了战斗。", date: "2019-04-06", like: 18560, collect: 12340, hot: 9800, rating: 4.7, playUrl: "https://www.baidu.com/s?wd=鬼灭之刃%20在线观看" },
    { id: 3, title: "盗梦空间", cover: "https://m.media-amazon.com/images/M/MV5BMjAxMzY3NjcxNF5BMl5BanBnXkFtZTcwNTI5OTM0Mw@@._V1_.jpg", type: ["电影"], genre: ["科幻", "悬疑"], score: 9.3, desc: "道姆·柯布是一位经验老道的窃贼，他在这一行业中算得上是最厉害的，因为他能够潜入人们精神最为脆弱的梦境中，窃取潜意识中有价值的秘密。", date: "2010-09-01", like: 15670, collect: 9870, hot: 9200, rating: 4.9, playUrl: "https://www.baidu.com/s?wd=盗梦空间%20在线观看" },
    { id: 4, title: "进击的巨人", cover: "https://m.media-amazon.com/images/M/MV5BNDFjYTIxMjctYTQ2ZC00OGQ4LWE3NzYtZWJkMjJhYzYzNDIyXkEyXkFqcGc@._V1_.jpg", type: ["动漫"], genre: ["动作", "悬疑"], score: 9.0, desc: "为了躲避巨人的攻击而逃往内地，人类建造了三重巨大的城墙，艾伦耶格尔在亲眼目睹母亲被巨人吞噬后，立誓要消灭所有的巨人。", date: "2013-04-07", like: 21340, collect: 15670, hot: 9900, rating: 4.6, playUrl: "https://www.baidu.com/s?wd=进击的巨人%20在线观看" },
    { id: 5, title: "功夫熊猫", cover: "https://m.media-amazon.com/images/M/MV5BODJkZTZhMWItMDI3Yy00ZWQzLTk2NTAtNjI0YjUzNDEwNjU2XkEyXkFqcGc@._V1_.jpg", type: ["电影"], genre: ["喜剧", "动作"], score: 8.6, desc: "笨拙的熊猫阿宝在机缘巧合下被选为神龙大侠，与盖世五侠一起保卫和平谷，对抗邪恶的太郎。", date: "2008-06-20", like: 9870, collect: 6540, hot: 8500, rating: 4.5, playUrl: "https://www.baidu.com/s?wd=功夫熊猫%20在线观看" },
    { id: 6, title: "你的名字", cover: "https://m.media-amazon.com/images/M/MV5BNGYyZGM5MGMtZDY2YS00ZTI0LWFjZTAtZmIyMzE0Mjk1YTIyXkEyXkFqcGc@._V1_.jpg", type: ["动漫"], genre: ["爱情", "奇幻"], score: 8.8, desc: "在日本的某个乡下小镇的高中女生三叶，每天过着忧郁的生活，而她的梦想则是能够成为东京的帅哥。", date: "2016-08-26", like: 16780, collect: 11230, hot: 9000, rating: 4.7, playUrl: "https://www.baidu.com/s?wd=你的名字%20在线观看" },
    { id: 7, title: "千与千寻", cover: "https://m.media-amazon.com/images/M/MV5BMjlmZmI5MDctNDE2YS00YWE0LWE5ZWItZDBhYWQ0NTcxNWRhXkEyXkFqcGc@._V1_.jpg", type: ["动漫"], genre: ["奇幻", "冒险"], score: 9.4, desc: "千寻和父母误入了一个诡异的世界，父母变成了猪，她不得不在汤屋工作，寻找解救父母的方法。", date: "2001-07-20", like: 22340, collect: 17890, hot: 9950, rating: 4.9, playUrl: "https://www.baidu.com/s?wd=千与千寻%20在线观看" },
    { id: 8, title: "楚门的世界", cover: "https://m.media-amazon.com/images/M/MV5BMDIzODcyY2EtMmY2MC00ZWVlLTgwMDAtZWYxODU1OWFhNjQ1XkEyXkFqcGc@._V1_.jpg", type: ["电影"], genre: ["剧情", "悬疑"], score: 9.4, desc: "楚门是一个平凡得不能再平凡的人，但他却不知道他生活中的每一秒钟都有上千部摄像机在对着他。", date: "1998-06-01", like: 14560, collect: 10230, hot: 8700, rating: 4.8, playUrl: "https://www.baidu.com/s?wd=楚门的世界%20在线观看" },
    { id: 9, title: "龙珠", cover: "https://m.media-amazon.com/images/M/MV5BYmI5NGI0Y2MtMjhhZC00MDZiLTg2YjctMzJkZDc3N2MwMjYyXkEyXkFqcGc@._V1_.jpg", type: ["动漫"], genre: ["动作", "冒险"], score: 9.4, desc: "讲述了孙悟空护送地球少女布玛寻找龙珠的冒险故事，以及之后与各大反派的战斗。", date: "1986-02-26", like: 25670, collect: 18920, hot: 9700, rating: 4.6, playUrl: "https://www.baidu.com/s?wd=龙珠%20在线观看" },
    { id: 10, title: "阿凡达", cover: "https://m.media-amazon.com/images/M/MV5BMTYwOTEwNjAzMl5BMl5BanBnXkFtZTcwODc5MTUwMw@@._V1_.jpg", type: ["电影"], genre: ["科幻", "冒险"], score: 8.8, desc: "人类在遥远的星系潘多拉开采资源，杰克·萨利卧底进入纳美族，逐渐爱上了这个美丽的种族。", date: "2009-12-18", like: 19870, collect: 13450, hot: 9600, rating: 4.7, playUrl: "https://www.baidu.com/s?wd=阿凡达%20在线观看" },
    { id: 11, title: "灌篮高手", cover: "https://m.media-amazon.com/images/M/MV5BNWQzYjA3YzAtNjIyOC00ZGQ3LWEwNzAtOGZhOTM3YjYxMjI2XkEyXkFqcGc@._V1_.jpg", type: ["动漫"], genre: ["喜剧", "运动"], score: 9.2, desc: "为了讨好暗恋对象赤木晴子，樱木花道加入篮球队。他从篮球小白成长为球队核心，带领球队向全国大赛发起冲击。", date: "1993-10-16", like: 23140, collect: 16780, hot: 9850, rating: 4.8, playUrl: "https://www.baidu.com/s?wd=灌篮高手%20在线观看" },
    { id: 12, title: "肖申克的救赎", cover: "https://m.media-amazon.com/images/M/MV5BMDAyY2FhYjctNDc5OS00MDNlLThiMGUtY2UxYWVkNjZjY2NlXkEyXkFqcGc@._V1_.jpg", type: ["电影"], genre: ["剧情", "犯罪"], score: 9.7, desc: "银行家安迪被冤枉入狱，在肖申克监狱中结识了瑞德，并在狱中度过了近20年的时光，最终实现了自我救赎。", date: "1994-09-23", like: 28970, collect: 21340, hot: 9980, rating: 5.0, playUrl: "https://www.baidu.com/s?wd=肖申克的救赎%20在线观看" }
];
...
function initializeImages() {
    ...
    if (bannerImg) bannerImg.src = 'https://images.unsplash.com/photo-1489599904472-1d493b9e3bb2?w=1920&q=80';
}
    ...
    card.innerHTML = `
        <div class="card-image-wrapper">
            <a href="${movie.playUrl}" target="_blank" rel="noopener noreferrer">
                <img class="card-image" src="${movie.cover}" alt="${movie.title}" loading="lazy" onerror="this.src='${fallback}'">
                <div class="card-play-overlay">▶ 点击观看</div>
            </a>
        ...
        <div class="card-content">
            ...
            <div class="card-meta">
                <span class="card-type">${movie.type.join(' / ')}</span>
                <span class="card-date">${movie.date}</span>
            </div>
            <div class="card-rating">${createStarRating(movie.id, userRating, false)}</div>
            <p class="card-desc">${movie.desc}</p>
            <div class="card-actions">
                <button class="action-btn ${isLiked ? 'liked' : ''}" onclick="toggleLike(${movie.id}, event)">❤️ <span>${formatNumber(movie.like + (isLiked ? 1 : 0))}</span></button>
                <button class="action-btn ${isCollected ? 'collected' : ''}" onclick="toggleCollect(${movie.id}, event)">🔖 <span>${formatNumber(movie.collect + (isCollected ? 1 : 0))}</span></button>
                <button class="action-btn play-btn" onclick="window.open('${movie.playUrl}', '_blank'); event.stopPropagation();">▶ <span>观看</span></button>
            </div>
        </div>`;
...
function openModal(m) {
    ...
    if (img) img.onerror = function() { this.src = fallback; };
    ...
    if (modalContent) {
        modalContent.innerHTML = `
            ...
            <div class="modal-meta">
                <span class="modal-meta-item">⭐ ${m.score}分</span>
                <span class="modal-meta-item">${m.type.join(' / ')}</span>
                <span class="modal-meta-item">${m.genre.join(' / ')}</span>
                <span class="modal-meta-item">${m.date}</span>
            </div>
            <div class="modal-rating-section">
                <div class="rating-label">我的评分：</div>
                ${createStarRating(m.id, userRating, true)}
            </div>
            <p class="modal-description">${m.desc}</p>
            <div class="modal-share">
                <button class="share-btn" onclick="shareMovie('${m.title}')">🔗 分享链接</button>
            </div>
            <div class="modal-actions">
                <a href="${m.playUrl}" target="_blank" class="modal-action-btn play-primary">▶ 立即观看</a>
                <button class="modal-action-btn primary" onclick="toggleLikeInModal(${m.id})">❤️ ${isLiked ? '已点赞' : '点赞'} (${formatNumber(m.like + (isLiked ? 1 : 0))})</button>
                <button class="modal-action-btn secondary" onclick="toggleCollectInModal(${m.id})">🔖 ${isCollected ? '已收藏' : '收藏'} (${formatNumber(m.collect + (isCollected ? 1 : 0))})</button>
            </div>
            <div class="modal-comments">
                <h3>💬 评论区 (${movieComments.length})</h3>
                ${renderComments(m.id)}
            </div>`;
    }
...
function closeModal() { const modal = document.getElementById('modalOverlay'); if (modal) modal.classList.remove('active'); document.body.style.overflow = ''; }

function shareMovie(title) {
    const url = window.location.href;
    const shareText = `我在影视推荐墙发现了《${title}》，推荐给大家！`;
    if (navigator.clipboard) {
        navigator.clipboard.writeText(shareText + '\n' + url).then(() => { alert('分享内容已复制到剪贴板！'); });
    } else {
...
function updateLightbox() {
    ...
    if (img) { img.src = movie.cover; img.onerror = function() { this.src = fallback; }; }
    const titleEl = document.getElementById('lightboxTitle');
    if (titleEl) titleEl.textContent = movie.title;
    const counterEl = document.getElementById('lightboxCounter');
    if (counterEl) counterEl.textContent = `${state.lightboxIndex + 1} / ${state.lightboxData.length}`;
}
...
function setupEventListeners() {
    ...
    if (filterButtons) filterButtons.addEventListener('click', e => { if (e.target.classList.contains('filter-btn')) { document.querySelectorAll('.filter-btn').forEach(b => b.classList.remove('active')); e.target.classList.add('active'); state.currentFilter = e.target.dataset.filter; renderCards(); } });
    const sortSelect = document.getElementById('sortSelect');
    if (sortSelect) sortSelect.addEventListener('change', e => { state.currentSort = e.target.value; renderCards(); });
